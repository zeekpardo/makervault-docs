...
Click **Add Folder** in the sidebar or use the welcome screen. Select any folder on your computer. The first level of subfolders is expanded in the sidebar by default so you can drill straight into them.
...
Hover over any folder in the sidebar to reveal a grip handle on the left. Drag the handle to reorder folders.
...
MakerVault can watch your macOS font directories so all your installed fonts appear in the library alongside your design files.
